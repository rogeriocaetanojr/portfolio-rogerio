...
export function Hero() {
  return (
    <section id="inicio" style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', scrollMarginTop: '100px', padding: '0 5vw' }}>
