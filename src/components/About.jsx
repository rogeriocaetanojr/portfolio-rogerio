export function About() {
  ...
  return (
    <section id="sobre" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', padding: '60px 5vw 4rem', borderBottom: '1px solid #222', scrollMarginTop: '100px' }}>
      <div style={{ backgroundColor: '#0E0E0E', border: '1px solid rgba(255, 255, 255, 0.18)', borderRadius: '16px', padding: '40px', maxWidth: '780px', width: '100%', margin: '0 auto' }}>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          ...
          <p style={textoStyle}>
            Já atuei como estagiário na Unisenai, no desenvolvimento full stack de um portal educacional para estudantes, experiência que me ajudou a entender o processo de construção de um produto de ponta a ponta. Você pode conhecer mais sobre esse e outros projetos na aba Projetos.
          </p>
